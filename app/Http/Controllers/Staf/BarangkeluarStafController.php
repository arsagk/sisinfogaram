...
class BarangkeluarStafController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return Inertia::render('Staf/Barangkeluar/Index', [
    ...
    public function create()
    {
        ...
        return Inertia::render('Staf/Barangkeluar/Create', [
            'is_admin' => $this->is_admin,
            'base_route' => $this->base_route,
    ...
    public function edit(Barangkeluar $barangkeluar)
    {
        ...
        return Inertia::render('Staf/Barangkeluar/Edit', [
