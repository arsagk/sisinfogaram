...
class BarangmasukStafController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return Inertia::render('Staf/Barangmasuk/Index', [
    ...
    public function create()
    {
        ...
        return Inertia::render('Staf/Barangmasuk/Create', [
            'is_admin' => $this->is_admin,
            'base_route' => $this->base_route,
    ...
    public function edit(Barangmasuk $barangmasuk)
    {
        ...
        return Inertia::render('Staf/Barangmasuk/Edit', [
