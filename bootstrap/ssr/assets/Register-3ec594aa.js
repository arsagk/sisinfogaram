...
function Register() {
  ...
  return /* @__PURE__ */ jsxs(Guest, { children: [
    ...
    /* @__PURE__ */ jsx("h4", { className: "relative text-2xl text-center text-blueGray-600 mb-4", children: "Sistem Informasi Pengelolaan Stock dan Pemesanan Garam UD Cap Batera" }),
