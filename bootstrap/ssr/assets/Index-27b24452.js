...
function CardTableClients({
  ...
  const { tipe_client, tipeclientOpt, tipeclientOpts } = usePage().props;
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "items-center w-full bg-transparent border-collapse", children: [
                ...
                children: /* @__PURE__ */ jsx(
                  Link,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-between", children: [
                      /* @__PURE__ */ jsx("span", { children: "Kode Client" }),
                      /* @__PURE__ */ jsx(
                        IconSort,
                        {
                          sortBy: "kode_client",
              ...
              "th",
              {
                ...
                children: /* @__PURE__ */ jsx(
                  Link,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-between", children: [
                      /* @__PURE__ */ jsx("span", { children: "Nama Client" }),
                      /* @__PURE__ */ jsx(
                        IconSort,
                        {
                          sortBy: "nama_client",
          ...
          /* @__PURE__ */ jsx("tbody", { children: clients.map(
            ({
              kode_client,
              id,
              nama_client,
              alamat_client,
              no_telp,
              tipe_client: tipe_client2
            }, index) => /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: kode_client }),
              ...
              /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: alamat_client }),
              ...
              /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: tipe_client2 }),
