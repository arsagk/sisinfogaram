...
function Login({
  ...
  return /* @__PURE__ */ jsx("main", { children: /* @__PURE__ */ jsxs("section", { className: "relative w-full h-full py-30 min-h-screen", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 h-full", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col content-center items-center justify-center h-full", children: /* @__PURE__ */ jsxs("div", { className: "w-full lg:w-4/12 px-4 h-screen flex justify-center flex-col", children: [
      status && /* @__PURE__ */ jsx("div", { className: "mb-4 font-medium text-sm text-green-600", children: status }),
      /* @__PURE__ */ jsx("h4", { className: "relative text-2xl text-center text-slate-100 mb-4", children: "Sistem Informasi Pengelolaan Stock dan Pemesanan Garam UD Cap Batera" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap relative", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-1/2 text-right", children: /* @__PURE__ */ jsx(
          Link,
          {
            href: "register",
            className: "text-blueGray-200 hover:text-blueGray-500",
            children: /* @__PURE__ */ jsx("span", { children: "Register" })
          }
        ) })
      ] })
    ] }) }) })
