...
const Edit = () => {
  const { barangmasuk, pembelianOpts, pembelianOpt, base_route } = usePage().props;
  const { data, setData, errors, post, processing } = useForm({
    ...
    pembelianOpt: pembelianOpt || void 0,
    _method: "PUT"
  });
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { children: /* @__PURE__ */ jsx("div", { className: "flex content-center items-center justify-center h-full", children: /* @__PURE__ */ jsx("div", { className: "w-full lg:w-2/3 px-4", children: /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg shadow-slate-400 rounded-lg bg-blueGray-200 border-0", children: [
    /* @__PURE__ */ jsxs("div", { className: "rounded-t mb-0 px-6 py-6", children: [
      /* @__PURE__ */ jsx("div", { className: "text-center mb-3", children: /* @__PURE__ */ jsx("h6", { className: "text-blueGray-500 text-lg font-bold", children: "Edit Barang Masuk" }) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-auto px-4 lg:px-10 py-10 pt-0", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
      ...
      /* @__PURE__ */ jsx(
        Input,
        {
          ...
          label: "Supplier",
          autoComplete: "off",
          value: pembelianOpt.pembelian.client.nama_client
        }
      ),
      /* @__PURE__ */ jsx(
        Input,
        {
          ...
          label: "Jenis",
          autoComplete: "off",
          value: pembelianOpt.pembelian.barang.nama_barang
        }
      ),
      /* @__PURE__ */ jsx(
        Input,
      ...
      /* @__PURE__ */ jsx(
        Input,
        {
          ...
          autoComplete: "off",
          value: pembelianOpt.pembelian.jumlah_pembelian
        }
      ),
      /* @__PURE__ */ jsx(
        NumberInput,
