...
function CardTableBarangs({
  ...
  const handleRemoveData = (id) => {
    router.delete(route("admin.barangs.destroy", id));
  };
  useEffect(() => {
    if (prevValues) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "rounded-t mb-0 px-4 py-3 border-0", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-2 flex-row items-start", children: [
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                theme: "blue",
                href: route(base_route + "barangs.create"),
        ...
        /* @__PURE__ */ jsx("div", { className: "block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "items-center w-full bg-transparent border-collapse", children: [
              ...
              "th",
              {
                ...
                children: /* @__PURE__ */ jsx(
                  Link,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-between", children: [
                      /* @__PURE__ */ jsx("span", { children: "Kode Barang" }),
                      /* @__PURE__ */ jsx(
                        IconSort,
                        {
                          sortBy: "kode_barang",
              ...
              "th",
              {
                ...
                children: /* @__PURE__ */ jsx(
                  Link,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-between", children: [
                      /* @__PURE__ */ jsx("span", { children: "Nama Barang" }),
                      /* @__PURE__ */ jsx(
                        IconSort,
                        {
                          sortBy: "nama_barang",
          ...
          /* @__PURE__ */ jsx("tbody", { children: barangs.map(
            ({
              kode_barang,
              id,
              nama_barang,
              ...
              /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: kode_barang }),
              ...
              /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: satuan }),
              /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: stok_barang }),
              /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: harga_beli }),
              /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: harga_jual }),
