...
const Edit = () => {
  ...
  const { data, setData, errors, post, processing } = useForm({
    client_id: pembelian.client_id || "",
    barang_id: pembelian.barang_id || "",
    kode_pembelian: pembelian.kode_pembelian || "",
    harga_perkg: pembelian.harga_perkg || "0",
    ongkos_perkg: pembelian.ongkos_perkg || "0",
    jumlah_pembelian: pembelian.jumlah_pembelian || "0",
    barangOpt,
    clientOpt,
    jenismuatanOpt,
    jenis_muatan: pembelian.jenis_muatan || jenismuatanOpt.value,
    lunas: pembelian.lunas || true,
    _method: "PUT"
  });
  function handleSubmit(e) {
    e.preventDefault();
    post(route(base_route + "pembelians.update", pembelian.id));
  }
  useRef(null);
  return /* @__PURE__ */ jsx(StafLayout, { children: /* @__PURE__ */ jsx("div", { className: "flex content-center items-center justify-center h-full", children: /* @__PURE__ */ jsx("div", { className: "w-full lg:w-2/3 px-4", children: /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg shadow-slate-400 rounded-lg bg-blueGray-200 border-0", children: [
    /* @__PURE__ */ jsxs("div", { className: "rounded-t mb-0 px-6 py-6", children: [
      /* @__PURE__ */ jsx("div", { className: "text-center mb-3", children: /* @__PURE__ */ jsx("h6", { className: "text-blueGray-500 text-lg font-bold", children: "Edit Pembelian" }) }),
