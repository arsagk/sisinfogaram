    ...
    @if ($barangmasuk)
        <table class="detail-isi-lap">
            <tr>
                ...
                <td>:</td>
                <td>{{ $barangmasuk->pembelian->kode_pembelian }}</td>
            </tr>
            <tr>
                <td>No Polisi</td>
                <td>:</td>
                <td>{{ $barangmasuk->no_pol }}</td>
            </tr>
            <tr>
                <td>No SPK</td>
                <td>:</td>
                <td>{{ $barangmasuk->pembelian->no_spk }}</td>
            </tr>
            <tr>
                <td>Tgl SPK</td>
                <td>:</td>
                @if ($barangmasuk->pembelian->no_spk)
                    <td>{{ \Carbon\Carbon::parse($barangmasuk->pembelian->tgl_spk)->format('d M Y') }}</td>
                @else
                    <td></td>
                @endif
            </tr>
            <tr>
                <td>Supplier</td>
                <td>:</td>
                <td>{{ $barangmasuk->pembelian->client->nama_client }}</td>
            </tr>
            <tr>
                <td>Jenis Garam</td>
                <td>:</td>
                <td>{{ $barangmasuk->pembelian->barang->nama_barang }}</td>
            </tr>
            <tr>
                <td>Jenis Muatan</td>
                <td>:</td>
                <td>{{ $barangmasuk->pembelian->jenis_muatan }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Jumlah</td>
                <td>:</td>
                <td>{{ $barangmasuk->pembelian->jumlah_pembelian }} Kg</td>
            </tr>
            <tr>
                <td>Jumlah Terima</td>
                <td>:</td>
                <td>{{ $barangmasuk->jumlah_terima }} Kg</td>
            </tr>
            <tr>
                <td>Jumlah Bayar</td>
                <td>:</td>
                <td>Rp. {{ $barangmasuk->jml_harga }}</td>
            </tr>
        </table>
    @else
    @endif
