...
import { Sopir, OptionSelect } from "@/types";
...
export default function CardTableSopirs({
    color = "light",
    sopirs,
    className = "",
    meta,
    ...
    const { tipe_sopir, tipesopirOpt, tipesopirOpts } = usePage<{
    ...
    const [tipeSopir, setTipeSopir] = useState(tipesopirOpt);
