                                    ...
                                    <ul className='list-none w-full px-6 bg-lightBlue-100  text-lightBlue-700'>
                                        {prosespermohonan.statusprosesperms.map((statusprosesperm: StatusprosespermProsespermohonan, index: number) => (
                                            <li key={index} className='w-full'>
                                                <ol className='flex flex-row w-full items-center text-xs gap-1 pb-2 pt-1'>
                                                    <li>
                                                    ...
                                                    <li>
                                                        {statusprosesperm.canRemove ?
                                                            <button
                                                                ...
                                                                className="text-lightBlue-400 background-transparent font-bold px-3 py-0 text-sm outline-none focus:outline-none hover:text-lightBlue-600 hover:scale-105 mr-1 ease-linear transition-all duration-150" type="button">
