...
// components
export default function CardTableKeluarbiayapermusers({ color = "light", keluarbiayapermusers, className = "", meta, labelLinks }: { color: "dark" | "light", keluarbiayapermusers: Keluarbiayapermuser[], className?: string, meta: { links: [], per_page: number, total: number }, labelLinks: any }) {
            ...
            >
                ...
                <div className="block w-full overflow-x-auto">
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody>
                            {
                                keluarbiayapermusers.map(({ id, created_at, instansi, metodebayar, kasbons, user, status_keluarbiayapermuser }, index) => (
                                    <tr key={index}>
