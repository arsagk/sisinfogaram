        ...
        <Modal show={showModal} maxWidth='md' closeable={false} onClose={() => setShowModal(false)}>
            <div className='p-4 bg-blueGray-100 rounded-md'>
                <form onSubmit={handleSubmit}>
                    <h1 className='font-bold text-xl text-blueGray-700 mb-4'>EDIT BIAYA PERMOHONAN</h1>
                    ...
                    <MoneyInput name='jumlah_bayar' disabled label='Jumlah Bayar' errors={errors.jumlah_bayar}
                    ...
                    <Input name='catatan_biayaperm' label='Catatan' errors={errors.catatan_biayaperms} value={data.catatan_biayaperms} onChange={e => setData('catatan_biayaperms', e.target.value)} />
